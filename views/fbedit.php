<div class="fbedit-holder">
	<form action="<?php echo site_url($this->module.'/facebookapp/save/')?>" method="post" name="frmCreate" id="frmCreate" >
			...
			<div class="form_inputs ui-tabs-panel ui-corner-bottom">
				<ul class="one_half">
					<li>
						...
						<div class="input type-text"><input type="text" name="name" id="name"  class="required" value="<?=$event?$event->name:null?>" /></div>
					</li>
				...
				<ul class="one_half">
					<li>
						...
						<div class="input type-text"><input type="text" id="event_date" name="event_date" value="<?=$event?DateTime_24hFormat_Into_AMPM_Date_SlashFormat($event->event_date):null?>" class="required" /></div>
					</li>
					
					<li>
						<label for="start_time">Start Time <small>The time at which your event begins.</small></label>
						<div class="input type-text"><input class="auto-select" type="text" id="start_time" name="start_time" value="<?=$event?Time24hFormat_Into_AMPMTime($event->start_time):null?>" /></div>     
					</li>
	
					<li>
						<label for="end_time">End Time <small>The time at which your event ends and people should start leaving.</small></label>
						<div class="input type-text"><input class="auto-select" type="text" id="end_time" name="end_time" value="<?=$event?Time24hFormat_Into_AMPMTime($event->end_time):null?>" /></div>
					</li>
				</ul>
			</div>
		</section>
		...
		<section class="item description">
			<div class="form_inputs ui-tabs-panel ui-corner-bottom">
				<ul>
					<li>
						<textarea class="wysiwyg-simple" id="description" name="description" cols="50" rows="10"><?=$event?$event->description:null?></textarea>
					</li>
				</ul>
			</div>
		</section>
	...
	<div class="footer-wrapper">
		<div class="floating-footer">
			<div class="buttons align-right padding-top">							
				...
				<button type="submit" name="btnAction" value="save_exit" class="btn blue">
					<span>Save &amp; Exit</span>
				</button>
				
				<a href="<?=site_url($this->module.'/facebookapp/edit/')?>" class="btn gray cancel">Cancel</a>
			</div>
		</div>
	</div>
	</form>
